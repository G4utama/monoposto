        ...
        <table>
            ...
            <tr>
                ...
                ${gp.map((gpData, index) => `<td style=" 
                    color: ${
                        driver.points[index] === 29 ? driver.borderColor : 
                        driver.points[index] === 28 ? driver.borderColor : 
                        driver.points[index] === 26 ? driver.borderColor :
